...
Most of the robot's Q&A part is currently based on OpenAI's GPT-3.5 (ChatGPT). We plan to integrate GPT-4 into some advanced features. At the same time, our self-developed LLM (Large Language Model) is in the experimental stage and will be launched in the near future.
