...
* Reward redemption:
  1. Genesis Pass: Creator benefits, more private robots, privileges for public robots, support for using the GPT-4 model for creation, and more benefits! (For those who have obtained the Genesis Pass, please be patient, we will transfer the Pass to your account within 7 days after casting.)
...
* Reward redemption adds the S2 commemorative medal: A season-exclusive medal that will soon be cast into an NFT and can serve as proof of eligibility for future airdrops.
